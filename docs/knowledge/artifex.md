...
Artifex is a CommonJS library and agent skill for creating art from code. One piece can produce an interactive page, a PNG, a WebM video, or an SVG when its drawing operations support that output.
