...
// --- the accessors that were implemented and never once run ---------------
  ...
  {
    why: 'the encoder colour space is dropped, so decoders assume limited range',
    file: 'core/film.js',
    from: "    box('avcC', avcC), colourBox(colour));",
    to: "    box('avcC', avcC));",
    expect: 'the film carries the colour space its encoder reported, and refuses to guess one',
  },
  {
