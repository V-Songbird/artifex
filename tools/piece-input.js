...
function callerDirectory(cwd = process.cwd(), env = process.env) {
  ...
  return ['page', 'seeds', 'replay', 'styles', 'film'].includes(env.npm_lifecycle_event) && env.npm_package_json && env.INIT_CWD
...
module.exports = { callerDirectory, isPiecePath, outputStem, imports, loadExternal };
